...
import com.geberl.gcodesender.listeners.ControllerStatus.AccessoryStates;
import com.geberl.gcodesender.listeners.ControllerStatus.EnabledPins;
import com.geberl.gcodesender.listeners.ControllerStatus.OverridePercents;
...
public class GrblUtils {
    ...
    public static final String GRBL_MACHINE_SET_HOTWIRE = "M88";
    public static final String GRBL_MACHINE_SET_MILL = "M89";
    // Switch Spindle Commands
    public static final String GRBL_SPINDLE_ON = "M03 S12000";
    public static final String GRBL_SPINDLE_OFF = "M05";
    
    /**
     * Gcode Commands
     */
    public static final String GCODE_RESET_COORDINATES_TO_ZERO_V9 = "G10 P0 L20 X0 Y0 Z0 A0 B0";
    public static final String GCODE_RESET_COORDINATES_TO_ZERO_V8 = "G92 X0 Y0 Z0 A0 B0";

    public static final String GCODE_RESET_Z_COORDINATES_TO_ZERO_V9 = "G10 P0 L20 Y0 A0";
    public static final String GCODE_RESET_Z_COORDINATES_TO_ZERO_V8 = "G92 Y0 A0";

    public static final String GCODE_RESET_COORDINATES_TO_ZERO_HOTWIRE_V9 = "G10 P0 L20 X0 Y0 Z0 A0";
    public static final String GCODE_RESET_COORDINATES_TO_ZERO_HOTWIRE_V8 = "G92 X0 Y0 Z0 A0";
     
    public static final String GCODE_RESET_COORDINATES_TO_ZERO_MILL_V9 = "G10 P0 L20 X0 Y0 Z0 A0 B0";
    public static final String GCODE_RESET_COORDINATES_TO_ZERO_MILL_V8 = "G92 X0 Y0 Z0 A0 B0";
    ...
    public static final String GCODE_RETURN_TO_ZERO_LOCATION_V8 = "G90 G0 X0 Y0 Z0 A0 B0";
    ...
    public static final String GCODE_PERFORM_HOMING_CYCLE_V8 = "G28 X0 Y0 Z0 A0 B0";
    ...
    static protected String getResetZaxisCoordsToZeroCommand(final double version, final Character letter) {
        if (version >= 0.9) {
            return GrblUtils.GCODE_RESET_Z_COORDINATES_TO_ZERO_V9;
        }
        else if (version >= 0.8 && (letter != null) && (letter >= 'c')) {
            // TODO: Is G10 available in 0.8c?
            // No it is not -> error: Unsupported statement
            return GrblUtils.GCODE_RESET_Z_COORDINATES_TO_ZERO_V8;
        }
        else if (version >= 0.8) {
            return GrblUtils.GCODE_RESET_Z_COORDINATES_TO_ZERO_V8;
        }
    ...
    static protected String getResetCoordsToZeroCommandHotWire(final double version, final Character letter) {
        if (version >= 0.9) {
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_HOTWIRE_V9;
        }
        else if (version >= 0.8 && (letter != null) && (letter >= 'c')) {
            // TODO: Is G10 available in 0.8c?
            // No it is not -> error: Unsupported statement
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_HOTWIRE_V8;
        }
        else if (version >= 0.8) {
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_HOTWIRE_V8;
        }
    ...
    static protected String getResetCoordsToZeroCommandMill(final double version, final Character letter) {
        if (version >= 0.9) {
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_MILL_V9;
        }
        else if (version >= 0.8 && (letter != null) && (letter >= 'c')) {
            // TODO: Is G10 available in 0.8c?
            // No it is not -> error: Unsupported statement
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_MILL_V8;
        }
        else if (version >= 0.8) {
            return GrblUtils.GCODE_RESET_COORDINATES_TO_ZERO_MILL_V8;
        }
    ...
    // Machine Specific Commands - HotWire / Mill
    static protected String getSwitchToHotWireCommand(final double version, final Character letter) {
        if ((version >= 0.8 && (letter != null) && letter >= 'c')
                || version >= 0.9) {
            return GrblUtils.GRBL_MACHINE_SET_HOTWIRE;
        }
        else {
            return "";
        }
    ...
    static protected String getSwitchToMillCommand(final double version, final Character letter) {
        if ((version >= 0.8 && (letter != null) && letter >= 'c')
                || version >= 0.9) {
            return GrblUtils.GRBL_MACHINE_SET_MILL;
        }
        else {
            return "";
        }
    ...
    static protected String getSpindleOnCommand(final double version, final Character letter) {
        if ((version >= 0.8 && (letter != null) && letter >= 'c')
                || version >= 0.9) {
            return GrblUtils.GRBL_SPINDLE_ON;
        }
        else {
            return "";
        }
    ...
    static protected String getSpindleOfCommand(final double version, final Character letter) {
        if ((version >= 0.8 && (letter != null) && letter >= 'c')
                || version >= 0.9) {
            return GrblUtils.GRBL_SPINDLE_OFF;
        }
        else {
            return "";
        }
    ...
    static protected ControllerStatus getStatusFromStatusString(
        ...
        if (!version.hasCapability(GrblCapabilitiesConstants.V1_FORMAT)) {
            ...
            for (String part : status.substring(0, status.length()-1).split("\\|")) {
                ...
                else if (part.startsWith("MMode:")) {
                	machineModeString = part.substring(7);
                }
            ...
            if (WCO == null) {
                ...
                if (lastStatus != null && lastStatus.getWorkCoordinateOffset() != null) {
                    ...
                    WCO = new Position(0,0,0,0,0, reportingUnits);
                }
            }

            // Calculate missing coordinate with WCO
            if (WPos == null) {
                WPos = new Position(MPos.x-WCO.x, MPos.y-WCO.y, MPos.z-WCO.z, MPos.a-WCO.a, MPos.b-WCO.b, reportingUnits);
            }
            if (MPos == null) {
                MPos = new Position(WPos.x+WCO.x, WPos.y+WCO.y, WPos.z+WCO.z, WPos.a+WCO.a, WPos.b+WCO.b, reportingUnits);
            }
            ...
            ControllerState state = getControllerStateFromStateString(stateString);
            return new ControllerStatus(stateString, machineModeString, state, MPos, WPos, feedSpeed, reportingUnits, spindleSpeed, overrides, WCO, pins, accessoryStates);
        }
    }
    ...
    static Pattern machinePattern = Pattern.compile("(?<=MPos:)(-?\\d*\\..\\d*),(-?\\d*\\..\\d*),(-?\\d*\\..\\d*),(-?\\d*\\..\\d*),(-?\\d*\\..\\d*)");
    static Pattern workPattern = Pattern.compile("(?<=WPos:)(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*)");
    static Pattern wcoPattern = Pattern.compile("(?<=WCO:)(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*),(\\-?\\d*\\..\\d*)");
