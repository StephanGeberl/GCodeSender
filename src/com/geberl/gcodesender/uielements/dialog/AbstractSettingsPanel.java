...
public abstract class AbstractSettingsPanel extends JPanel {
    ...
    public AbstractSettingsPanel(Settings settings, IChanged changer) {
    ...
    private void initActions() {
        for (Component c : components) {
            ...
            if (clazz == Spinner.class) {
                ...
                ((ComboBox)c).comboBox.addActionListener((ActionEvent e) -> {
                    change();
                });
            }
...
//    }
     ...
     */
    protected class DecimalSpinner extends JPanel {
        JLabel label;
        public JSpinner spinner;
        public DecimalSpinner(String text, SpinnerModel model) {
    ...
    protected class ComboBox extends JPanel {
        JLabel label;
        public JComboBox<String> comboBox;
        public ComboBox(String text, String[] aItems) {
            label = new JLabel(text);
            comboBox = new JComboBox(aItems);
            setLayout(new BorderLayout());
            add(comboBox, BorderLayout.CENTER);
            add(label, BorderLayout.WEST);
        }

        public void setSelectedItem(String aValue) { comboBox.setSelectedItem(aValue); }
