...
public class ControllerStatus {
    ...
    private final String machineModeString;
     ...
     */
    public ControllerStatus(String stateString, String machineModeString, ControllerState state, Position machineCoord,
     ...
     */
     // depricated is irrelevant here because we only use GRBL
	public String getStateString() {
        return stateString;
    }

    public String getMachineMode() {
        return machineModeString;
    }
