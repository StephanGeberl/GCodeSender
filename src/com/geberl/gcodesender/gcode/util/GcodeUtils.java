...
public class GcodeUtils {
     ...
     * @param dirY     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param dirZ     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param dirA     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param units    the units to use for movement
     */
    public static String generateMoveCommand(String command, double distance, double feedRate, int dirX, int dirY, int dirZ, int dirA, Units units) {
        StringBuilder sb = new StringBuilder();
     ...
     * @param dirZ     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param dirA     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param dirB     1 for positive movement, 0 for no movement, -1 for negative movement
     * @param units    the units to use for movement
     */
    public static String generateMoveCommand(String command, double distance, double feedRate, int dirX, int dirY, int dirZ, int dirA, int dirB, Units units) {
        StringBuilder sb = new StringBuilder();
