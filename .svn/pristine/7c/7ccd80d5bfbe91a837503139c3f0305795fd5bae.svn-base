...
public class ControllerStatusBuilder {
    ...
    private String machineModeString = "";
    ...
    public static ControllerStatusBuilder newInstance(ControllerStatus controllerStatus) {
        ...
        if(controllerStatus != null) {
            controllerStatusBuilder.setStateString(controllerStatus.getStateString())
                ...
                .setMachineModeString(controllerStatus.getMachineMode())
    ...
    public ControllerStatusBuilder setMachineModeString(String machineModeString) {
        this.machineModeString = machineModeString;
        return this;
    }
    ...
    public ControllerStatus build() {
        return new ControllerStatus(stateString, machineModeString, state, machineCoord, workCoord, feedSpeed, feedSpeedUnits, spindleSpeed, overrides, workCoordinateOffset, pins, states);
    }
}