...
import com.geberl.gcodesender.firmware.FirmwareSettingUtils;
import com.geberl.gcodesender.firmware.FirmwareSettingsException;
...
import com.geberl.gcodesender.uielements.components.FirmwareSettingsFileTypeFilter;
import com.geberl.gcodesender.utils.StringNumberComparator;
...
public class FirmwareSettingsDialog extends JDialog implements IFirmwareSettingsListener, WindowListener {
    ...
    private void initLocalization() {
        ...
        tcm.getColumn(0).setHeaderValue("Setting");
        tcm.getColumn(1).setHeaderValue("Value");
        tcm.getColumn(2).setHeaderValue("Description");
